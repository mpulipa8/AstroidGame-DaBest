...
public class Menu extends Applet implements ActionListener 
{
    ...
    { 
       ...
       try{
           ssss=ImageIO.read(new File("Unknown.jpeg"));
        }catch(IOException e){
        }
       ...
       g.drawImage(ssss,0,0,this);
       g.drawImage(ssss,600,0,this);
       g.drawImage(ssss,0,600,this);
       g.drawImage(ssss,600,600,this);
    }
